const translations = {
  az: {
    ...
    heroTitle: "Zirvə FC rəsmi sponsorları",
    ...
    sectionDesc: "Klubun rəsmi sponsorları və strateji tərəfdaşları.",
    footerText: "Klub sponsorlarının rəsmi səhifəsi.",
  ...
  ru: {
    ...
    heroTitle: "Официальные спонсоры Zirvə FC",
    ...
    sectionDesc: "Официальные спонсоры и стратегические партнёры клуба.",
    footerText: "Официальная страница спонсоров клуба.",
  ...
  en: {
    ...
    heroTitle: "Official sponsors of Zirvə FC",
    ...
    sectionDesc: "Official sponsors and strategic partners of the club.",
    footerText: "Official club sponsors page.",
